...
const CircularBar = forwardRef((props, ref) => {
  const {classNames, styles, children, ...curProps} = props;
  const {diameter, color, backgroundColor, thickness, value, minValue, maxValue, label, ...rootProps} = curProps;
